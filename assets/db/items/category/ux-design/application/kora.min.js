    ...
    <div class="col">
        <div class="product-card ${product.category}">
            <div class="product-media">
                ...
                <a class="product-image" href="${product.PreviewLink}" target="_blank">
                    <img src="${product.img}" alt="product">
                </a>
                <div class="product-widget">
                    <a title="Product View" href="${product.PreviewLink}" class="ri-eye-line" style="display: ${product.displayPreview};" target="_blank"></a>
                </div>
            </div>
            <div class="product-content">
                ...
                <h6 class="product-name">
                    <a href="${product.PreviewLink}">${product.name}</a>
                </h6>
