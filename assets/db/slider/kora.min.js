...
db.collection("/kora/product/trending/").onSnapshot((snapshot) => {
    fetchTrending(snapshot.docs);
});

// --------------------fetch accessories from backend --------------------
const exploreContainer = document.querySelector(".koraSlider");
        ...
        <div class="product-card">
            <div class="product-media">
                ...
                <div class="product-widget">
                    ...
                    <a title="Product View" href="#" class="fas fa-eye" style="display: ${product.displayBuy};"></a>
                </div>
            </div>
